...
export interface CoachMeeting {
   ...
   *  link was set inside the report's week window contribute to the score. */
...
export type CoachingTab = 'inbox' | 'everfit' | 'roster' | 'onboarding' | 'performance' | 'meetings' | 'milestones' | 'eod' | 'financials' | 'expenses' | 'nutrition' | 'client-progress' | 'ask-ahmad' | 'referrals';
