...
import { AlertTriangle, CheckCircle, XCircle, Clock, ChevronDown, ChevronRight, DollarSign, RotateCcw, ClipboardCheck, Copy } from "lucide-react";
...
// ============ Client Check-In Link Box ============
// Lives at the bottom of the Milestones tab. Coaches grab the public
// /check-in URL here and paste it into Everfit DMs to clients on the
// two scheduled dates each month. Has a one-click copy button so coaches
// don't have to manually highlight the link.

function CheckInLinkBox() {
