...
function prettyName(id) {
  return ({ "cmo": "CMO", "ad-decisions": "Kill / Scale Decision", "ccos-ad-launcher": "CCOS Ad Launcher", "ad-copywriter": "Ad Copywriter", "womens-ad-voice": "Women's Ad Voice" })[id] || titleCase(id);
}
