...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  callbacks: {
    ...
    jwt: async ({ token, profile }) => {
      ...
      const ALL_TABS = ["/","/mozi-metrics","/sales","/coaching","/onboarding","/ads","/studio","/studio-2","/outreach","/leads","/outreach-runs","/sales-hub","/media-buyer","/accountant","/intelligence","/log","/settings"];
