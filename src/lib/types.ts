...
export type CoachingTab = 'everfit' | 'roster' | 'onboarding' | 'performance' | 'meetings' | 'milestones' | 'eod' | 'financials' | 'expenses' | 'nutrition' | 'client-progress' | 'ask-ahmad' | 'referrals';
